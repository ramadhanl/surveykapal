	...
	<div class="row">
		<div class="col-sm-12 col-lg-12">
			<div class="judul-konten">
				<p><a style="text-decoration:underline;" href="<?php echo base_url(); ?>home/teori_awal_kondisi_kapal"> Teori Kondisi Kapal</a></p>
			</div>
			<table class="display">
	          	<thead>
	            <tr>
	              <th><a href="<?php echo base_url(); ?>home/teori_awal_lambung_kapal">Lambung</a></th>
	              <th style="background-color: #FFFFFF;"><a style="color: #2F8ABB;" href="<?php echo base_url(); ?>home/teori_awal_permesinan_kapal">Permesinan</a></th>
	              <th><a href="<?php echo base_url(); ?>home/teori_awal_outfitting_kapal">Outfitting</a></th>
	            </tr>
	        	</thead>
	        </table>
...
<a href="<?php echo base_url(); ?>home/teori_awal2" class="btn btn-primary col-sm-12" style="margin-top:20px;margin-bottom:20px;">Kembali </a>			
